...
public class harry_potter {
    public static void main(String[] args) {
        ...
        char Patronus_charm;
        int Health, Choice;
        int Grindylow = 20, Troll = 40, Basilisk = 80, Dementor = 60;
        ...
        switch (Choice) {
            case 1:
                System.out.print(
                        "Harry is attacked by a Grindylow which deals 20 damage. \n" + "Harry ends the battle with "
                                + (Health - Grindylow) + " Health\n");
                Health = Health - Grindylow;
                break;
            case 2:
                System.out.print(
                        "Harry is attacked by a Troll which deals 40 damage. \n" + "Harry ends the battle with "
                                + (Health - Troll) + " Health\n");
                Health = Health - Troll;
                break;
            case 3:
