...
public class unit_4 {
     ...
     * }
     * 
     * public static voide main(string main[]){
     * 
     * 
     * 
     * }
    ...
    public static void main(String[] args) {
        Scanner skb = new Scanner(System.in);
        System.out.println("enter the 3 value and they will show the biggest one");
        int x = skb.nextInt();
        int y = skb.nextInt();
        int z = skb.nextInt();

        if (x == y && y == z) {
            System.out.println("all the three value are equal");
        } else {
            int largest = findlargest(x, y, z);
            System.out.println(largest + " the largest ");
        }
    }
}
